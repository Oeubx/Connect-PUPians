                          ...
                          if (valueOrDefault(
                            ...
                            AuthUserStreamWidget(
                              builder: (context) => FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  context
                                      .pushNamed(CreateClassWidget.routeName);
                                },
                              ),
                            ),
                        ],
                          ...
                          StreamBuilder<List<ClassesRecord>>(
                            stream: queryClassesRecord(
                              queryBuilder: (classesRecord) =>
                                  classesRecord.orderBy('latest_update_time',
                                      descending: true),
                            ),
                            builder: (context, snapshot) {
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (context, listViewIndex) {
                                  ...
                                  return Visibility(
                                    visible: (listViewClassesRecord.classProf ==
                                            currentUserReference) ||
                                        (listViewClassesRecord.classStudents
                                                .contains(
                                                    currentUserReference) ==
                                            true) ||
                                        (listViewClassesRecord.classSubProfs
                                                .contains(
                                                    currentUserReference) ==
                                            true),
                                    child: Padding(
