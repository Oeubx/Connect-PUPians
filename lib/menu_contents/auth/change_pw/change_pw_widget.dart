...
import 'change_pw_model.dart';
export 'change_pw_model.dart';

class ChangePwWidget extends StatefulWidget {
  const ChangePwWidget({super.key});

  static String routeName = 'Change_Pw';
  static String routePath = '/changePw';

  @override
  State<ChangePwWidget> createState() => _ChangePwWidgetState();
}

class _ChangePwWidgetState extends State<ChangePwWidget> {
  late ChangePwModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChangePwModel());
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              'You will be receiving an email after clicking the following button. Kindly input the following textfields before proceeding.',
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              context.goNamedAuth(
                                  AppSettingsWidget.routeName, context.mounted);
                            },
                            text: 'Continue',
