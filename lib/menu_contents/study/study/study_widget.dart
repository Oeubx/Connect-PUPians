...
class StudyWidget extends StatefulWidget {
  ...
  static String routeName = 'Study';
  static String routePath = '/study';
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      controller:
                                          _model.additionalInfoTextController,
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    if (!((_model.specializationValue == null ||
                                        ...
                                        (_model.additionalInfoTextController
                                            ...
                                            _model.additionalInfoTextController
                                                    .text ==
                                                ''))) {
                                      await StudyPostsRecord.collection
                                          .doc()
                                          .set(createStudyPostsRecordData(
                                            tutorSpecialization:
                                                _model.specializationValue,
                                            tutorPosttext: _model
                                                .additionalInfoTextController
                                                .text,
                                            tutorPostTime: getCurrentTimestamp,
                                            tutorPosterRef:
                    ...
                    StreamBuilder<List<StudyPostsRecord>>(
                      stream: queryStudyPostsRecord(
                        queryBuilder: (studyPostsRecord) => studyPostsRecord
                            .orderBy('tutor_postTime', descending: true),
                      ),
                      builder: (context, snapshot) {
                        ...
                        List<StudyPostsRecord> listViewStudyPostsRecordList =
                            snapshot.data!;
                        ...
                        return ListView.builder(
                          ...
                          itemCount: listViewStudyPostsRecordList.length,
                          itemBuilder: (context, listViewIndex) {
                            final listViewStudyPostsRecord =
                                listViewStudyPostsRecordList[listViewIndex];
                            return Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 5.0),
                              child: Container(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            context.pushNamed(
                                              StudyFeedbackUIWidget.routeName,
                                              queryParameters: {
                                                'studypostsref': serializeParam(
                                                  listViewStudyPostsRecord
                                                      .reference,
