...
import 'whole_post_u_i_of_group_model.dart';
export 'whole_post_u_i_of_group_model.dart';

class WholePostUIOfGroupWidget extends StatefulWidget {
  const WholePostUIOfGroupWidget({
    super.key,
  ...
  static String routeName = 'WholePost_UI_ofGroup';
  static String routePath = '/wholePostUIOfGroup';

  @override
  State<WholePostUIOfGroupWidget> createState() =>
      _WholePostUIOfGroupWidgetState();
}

class _WholePostUIOfGroupWidgetState extends State<WholePostUIOfGroupWidget> {
  late WholePostUIOfGroupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WholePostUIOfGroupModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final wholePostUIOfGroupUsersRecord = snapshot.data!;
                                    ...
                                    Padding(
                                      ...
                                      child: StreamBuilder<List<GroupsRecord>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          List<GroupsRecord>
                                              iconButtonGroupsRecordList =
                                              snapshot.data!;
                                          // Return an empty Container when the item does not exist.
                                          if (snapshot.data!.isEmpty) {
                                            return Container();
                                          }
                                          final iconButtonGroupsRecord =
                                              iconButtonGroupsRecordList
                                                      .isNotEmpty
                                                  ? iconButtonGroupsRecordList
                                                      .first
